    ...
    return (
        <div>
            <div className="mb-3 mt-8">
                ...
                <p className="text-sm"><Link to='https://www.instagram.com/sku_bisang/' className="flex items-center justify-center"><AiOutlineInstagram className="mr-1" /><span>sku_39th_renew</span></Link></p>
            </div>
